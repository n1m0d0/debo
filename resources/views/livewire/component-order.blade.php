            ...
            <tbody>
                @foreach ($orders as $order)
                    <tr
                            ...
                            @foreach ($order->details as $detail)
                                <ul>
                                    <span class="flex items-center text-sm font-medium text-gray-900 dark:text-white">
                                        ...
                                        {{ $detail->product->name }} 
                                        <span class="ml-2 text-xs text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-6 py-4">
                            <a wire:click='finish({{ $order->id }})'
                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline cursor-pointer">{{ __('Finalizar') }}</a>
                            <a wire:click='destroy({{ $order->id }})'
