    ...
    @if ($activity == 'create')
        <x-form-section submit="store">
            ...
            <x-slot name="description">
                {{ __('You must enter the basic information of your category.') }}
            </x-slot>
                    ...
                    <label for="photo"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            @if ($photo)
                                <img src="{{ $photo->temporaryUrl() }}" class="w-full h-48 object-cover">
                            @else
                                <img src="{{ Storage::url($photoBefore) }}" class="w-full h-48 object-cover">
                            @endif
                        </div>
                        <input id="photo" type="file" class="hidden" wire:model='photo' />
                    </label>
                ...
                @foreach ($categories as $category)
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full" src="{{ Storage::url($category->photo) }}">
                            <div class="pl-3">
